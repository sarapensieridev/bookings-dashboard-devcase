...
exports.getBookings = async (event) => {
  ...
  console.log(`📥 Request received - pageSize: ${pageSize}, hasToken: ${!!nextPageToken}`);
  ...
  console.log(`📤 Response - Bookings: ${bookings.length}, Payload: ${payloadSizeKB} KB, hasMore: ${!!returnToken}`);
  console.log(`---`);
